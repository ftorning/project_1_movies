...
zoolander = media.Movie("Zoolander",
                        "At the end of his career, a clueless fashion model \
                        is brainwashed to kill the Prime Minister \
                        of Malaysia.",
...
dumb_and_dumber = media.Movie("Dumber and Dumber",
                              "The cross-country adventures of two good-hearted \
                              but incredibly stupid friends.",
...
bridesmaids = media.Movie("Bridesmaids",
                          ...
                          threatens to upend the life of \
                          an out-of-work pastry chef.",
...
redviolin = media.Movie("The Red Violin",
                        "A perfect violin inspires passion, making \
                        its way through three centuries of owners.",
                        "http://www.impawards.com/1999/posters/red_violin_ver2.jpg",
                        "https://youtu.be/3feDUcDRNAg"
                        )

flawless = media.Movie("Flawless",
                       "A police officer suffers a stroke and is \
                       prescribed singing lessons - with the drag \
                       queen next door.",
...
hollandsopus = media.Movie("Mr. Holland's Opus",
                           "A professional musician and composer finds \
...
thering = media.Movie("The Ring",
                      ...
                      which seems to cause the death of anyone in a \
                      week of viewing it.",
...
conjuring = media.Movie("The Conjuring",
                        ...
                        to help a family terrorized by a dark presence \
                        in their farmhouse.",
...
orphan = media.Movie("Orphan",
                     "A husband and wife who recently lost their baby adopt \
                     a 9-year-old girl who is not nearly as innocent \
                     as she claims to be.",
...
# Calls fresh_tomatoes.py modified to include storyline
